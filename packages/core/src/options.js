...
const HEADER_RENDERER_OPTION_TYPES = {
    ...
    avoidLoneSyllables: 'boolean',
    gapOutlierThresholdMin: 'number',
    wrapCondenseMin: 'number',
    wrapStretchMax: 'number',
    recitationLoneWordMin: 'number',
    staffGap: 'number',
    lyricDistance: 'number',
    lyricMinStaffDistance: 'number',
    lyricLineSkip: 'number',
    lyricHyphenMinLen: 'number',
    lyricHyphenMaxLen: 'number',
    lyricHyphenWidth: 'number',
    lyricHyphenSpace: 'number',
    lyricHyphenPos: 'number',
    lyricHyphenRepeat: 'number',
